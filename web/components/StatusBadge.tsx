 ...
 *
 * `tone` names a Badge variant one-for-one (see components/ui/badge.tsx). Keeping the mapping in
 * lib/status.ts means a new status cannot be added without the compiler pointing at it. */
