 ...
 * leaf that wants to say one sentence, so threading a provider through them buys nothing. Lived inside
 * `copyText` until a second caller needed it — the graph's expand, which had been silent.
 */
