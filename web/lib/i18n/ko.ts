...
export const ko: typeof en = {
  ...
  home: {
    ...
    heading: "YOKE는 협업을 위해 믿을 수 있는 Context를 공유합니다.",
    lede: "사람과 에이전트가 같은 협업 Context를 보게 합니다. 결정, 사실, 리소스, 용어, 누가 무엇을 하는지를 한 협업에 고정합니다. 에이전트는 그 협업의 verified Context를 출처와 감사 로그와 함께 먼저 받고, draft는 사람이 승격하기 전까지 제외됩니다.",
    cards: {
      collaboration: {
        title: "협업",
        body: "협업을 팀과 에이전트가 함께 쓰는 Context로 둡니다. 참여자, 붙은 지식, 그리고 그 일에 대한 브리핑을 한곳에서 봅니다.",
      },
      govern: {
        title: "검증",
