...
export const ko: typeof en = {
  ...
  home: {
    ...
    heading: "YOKE는 각 협업에 믿을 수 있는 AI 맥락을 붙입니다.",
    lede: "사람, 결정, 사실, 리소스, 용어를 실제 일이 벌어지는 협업에 고정합니다. 에이전트는 그 협업의 verified 맥락을 출처와 감사 로그와 함께 먼저 받고, draft는 사람이 승격하기 전까지 제외됩니다.",
    cards: {
      collaboration: {
        title: "협업",
        body: "협업을 공유 작업 scope로 씁니다. 참여자, 붙은 지식, 그리고 그 일에 대해 에이전트가 받는 브리핑을 한곳에서 봅니다.",
      },
      govern: {
        title: "검증",
